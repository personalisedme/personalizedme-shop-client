    ...
    function (r = {}) {
      ...
      if (f) {
        ...
        (p = c ? m.dirname(p) + '/' : __dirname + '/'),
          (a = (e, r) => (
            (e = V(e) ? new URL(e) : m.normalize(e)), h.readFileSync(e, r ? void 0 : 'utf8')
          )),
          (s = (e) => {
            var r = a(e, !0);
          ...
          !o.thisProgram && process.argv.length > 1 && (u = process.argv[1].replace(/\\/g, '/')),
      ...
      Y((I = 'pspdfkit.wasm.wasm')) || ((L = I), (I = o.locateFile ? o.locateFile(L, p) : p + L));
      var G = (e) => {
      ...
      var ae = {
          ...
          shutdown() {},
          register(e, r) {
            (ae.ttys[e] = { input: [], output: [], ops: r }), ce.registerDevice(e, ae.stream_ops);
          },
          stream_ops: {
            open(e) {
          ...
          default_tty_ops: {
            ...
            fsync(e) {
              e.output && e.output.length > 0 && (y(ee(e.output, 0)), (e.output = []));
            },
            ioctl_tcgets: (e) => ({
              c_iflag: 25856,
              c_oflag: 5,
          ...
          default_tty1_ops: {
            ...
            fsync(e) {
              e.output && e.output.length > 0 && (g(ee(e.output, 0)), (e.output = []));
            }
          }
        },
        ie = (e) => {
        ...
        se = {
          ...
          createNode(e, r, t, n) {
            ...
            se.ops_table ||
              (se.ops_table = {
                ...
                file: {
                  node: { getattr: se.node_ops.getattr, setattr: se.node_ops.setattr },
                  stream: {
          ...
          stream_ops: {
            ...
            write(e, r, t, n, o, a) {
              ...
              var i = e.node;
              if (
                ((i.timestamp = Date.now()), r.subarray && (!i.contents || i.contents.subarray))
              ) {
              ...
              if ((se.expandFileStorage(i, o + n), i.contents.subarray && r.subarray))
          ...
          mount(e) {
            ...
            function n(e) {
              for (var n = e.split('/'), o = r, a = 0; a < n.length - 1; a++) {
                ...
                t[i] || (t[i] = de.createNode(o, n[a], de.DIR_MODE, 0)), (o = t[i]);
              }
              return o;
            }
            function o(e) {
            ...
            return (
              Array.prototype.forEach.call(e.opts.files || [], function (e) {
                de.createNode(n(e.name), o(e.name), de.FILE_MODE, 0, e, e.lastModifiedDate);
              }),
              ...
              (e.opts.packages || []).forEach(function (e) {
                e.metadata.files.forEach(function (r) {
                  ...
                  de.createNode(n(t), o(t), de.FILE_MODE, 0, e.blob.slice(r.start, r.end));
                });
              }),
              r
            );
        ...
        ce = {
          ...
          lookupPath(e, r = {}) {
            ...
            for (
              var t = e.split('/').filter((e) => !!e), n = ce.root, o = '/', a = 0;
              a < t.length;
              a++
            ) {
              var i = a === t.length - 1;
              ...
              if (
                ...
                for (var s = 0; ce.isLink(n.mode); ) {
                  ...
                  if (
                    ...
                    (n = ce.lookupPath(o, { recurse_count: r.recurse_count + 1 }).node),
                    s++ > 40)
                  )
                    throw new ce.ErrnoError(32);
                }
          ...
          mayOpen: (e, r) =>
            e
              ? ce.isLink(e.mode)
                ? 32
                : ce.isDir(e.mode) && ('r' !== ce.flagsToPermissionString(r) || 512 & r)
                  ? 31
          ...
          mount(e, r, t) {
            ...
            if (!o && !a) {
              ...
              if (((t = i.path), (n = i.node), ce.isMountpoint(n))) throw new ce.ErrnoError(10);
            ...
            return (
              (l.mount = s),
              (s.root = l),
              o ? (ce.root = l) : n && ((n.mounted = s), n.mount && n.mount.mounts.push(s)),
              l
            );
          },
          unmount(e) {
          ...
          create: (e, r) => (
            (r = void 0 !== r ? r : 438), (r &= 4095), (r |= 32768), ce.mknod(e, r, 0)
          ),
          mkdir: (e, r) => (
            (r = void 0 !== r ? r : 511), (r &= 1023), (r |= 16384), ce.mknod(e, r, 0)
          ),
          mkdirTree(e, r) {
          ...
          rename(e, r) {
            ...
            if ('.' !== (d = Z.relative(r, o)).charAt(0)) throw new ce.ErrnoError(55);
            try {
              l = ce.lookupNode(n, s);
            } catch (e) {}
            if (u !== l) {
              ...
              if ((f = l ? ce.mayDelete(n, s, c) : ce.mayCreate(n, s))) throw new ce.ErrnoError(f);
              if (!t.node_ops.rename) throw new ce.ErrnoError(63);
              if (ce.isMountpoint(u) || (l && ce.isMountpoint(l))) throw new ce.ErrnoError(10);
          ...
          chmod(e, r, t) {
            var n;
            'string' == typeof e ? (n = ce.lookupPath(e, { follow: !t }).node) : (n = e);
          ...
          chown(e, r, t, n) {
            var o;
            'string' == typeof e ? (o = ce.lookupPath(e, { follow: !n }).node) : (o = e);
          ...
          truncate(e, r) {
            ...
            var t;
            'string' == typeof e ? (t = ce.lookupPath(e, { follow: !0 }).node) : (t = e);
          ...
          open(e, r, t) {
            ...
            if ((ce.isChrdev(n.mode) && (r &= -513), 65536 & r && !ce.isDir(n.mode)))
            ...
            return (
              ...
              !o.logReadFiles ||
                1 & r ||
                (ce.readFiles || (ce.readFiles = {}), e in ce.readFiles || (ce.readFiles[e] = 1)),
              s
            );
          },
          close(e) {
          ...
          readFile(e, r = {}) {
            ...
            return (
              ce.read(n, a, 0, o, 0),
              'utf8' === r.encoding ? (t = ee(a, 0)) : 'binary' === r.encoding && (t = a),
              ce.close(n),
              t
            );
          },
          ...
          createDefaultDevices() {
            ce.mkdir('/dev'),
              ce.registerDevice(ce.makedev(1, 3), { read: () => 0, write: (e, r, t, n, o) => n }),
          ...
          createStandardStreams() {
            ...
            ce.open('/dev/stdin', 0), ce.open('/dev/stdout', 1), ce.open('/dev/stderr', 1);
          },
          ensureErrnoError() {
            ce.ErrnoError ||
          ...
          staticInit() {
            ce.ensureErrnoError(),
              ...
              (ce.filesystems = { MEMFS: se, WORKERFS: de });
          },
          init(e, r, t) {
          ...
          createDataFile(e, r, t, n, o, a) {
            var i = r;
            e && ((e = 'string' == typeof e ? e : ce.getPath(e)), (i = r ? J.join2(e, r) : e));
            var s = ue(n, o),
              l = ce.create(i, s);
            if (t) {
              if ('string' == typeof t) {
                for (var u = new Array(t.length), d = 0, c = t.length; d < c; ++d)
                  u[d] = t.charCodeAt(d);
                t = u;
              }
              ce.chmod(l, 146 | s);
          ...
          forceLoadFile(e) {
            ...
            try {
              (e.contents = oe(a(e.url), !0)), (e.usedBytes = e.contents.length);
            } catch (e) {
              throw new ce.ErrnoError(29);
            }
          },
          createLazyFile(e, r, t, n, o) {
            ...
            return (
              ...
              (u.read = (e, r, t, n, o) => (ce.forceLoadFile(l), d(e, r, t, n, o))),
              (u.mmap = (e, r, t, n, o) => {
                ce.forceLoadFile(l);
                var a = ie(r);
        ...
        pe = {
          ...
          doStat(e, r, t) {
            try {
              ...
              if (e && e.node && J.normalize(r) !== J.normalize(ce.getPath(e.node))) return -54;
              throw e;
            }
            (k[t >> 2] = n.dev),
              (k[(t + 4) >> 2] = n.mode),
      ...
      var he = (e, r) => ((r + 2097152) >>> 0 < 4194305 - !!e ? (e >>> 0) + 4294967296 * r : NaN);
      ...
      var we,
        ...
        De = (e) => (e || Ce('Cannot use deleted val. handle = ' + e), ke.get(e).value),
        Fe = (e) => {
          switch (e) {
            case void 0:
              return 1;
        ...
        Ne = (e, r, t) => {
          (r = xe(e, r)),
            ze.hasOwnProperty(r) ? Ce(`Tried to register registered instance: ${r}`) : (ze[r] = t);
        },
        Ue = {},
        We = (e) => {
          var r = ct(e),
        ...
        Xe = (e, r) => (
          (r.ptrType && r.ptr) || qe('makeClassHandle requires ptr and ptrType'),
      ...
      var sr = (e, r, t) => {
        ...
        lr = (e, r, t) => {
          o.hasOwnProperty(e)
            ? ((void 0 === t ||
                (void 0 !== o[e].overloadTable && void 0 !== o[e].overloadTable[t])) &&
      ...
      var dr = (e, r, t) => {
        for (; r !== t; )
          r.upcast || Ce(`Expected null or instance of ${t.name}, got an instance of ${r.name}`),
            (e = r.upcast(e)),
            (r = r.baseClass);
        return e;
      };
      function cr(e, r) {
        if (null === r) return this.isReference && Ce(`null is not a valid ${this.name}`), 0;
        r.$$ || Ce(`Cannot pass "${Dr(r)}" as a ${this.name}`),
          r.$$.ptr || Ce(`Cannot pass deleted object as a pointer of type ${this.name}`);
      ...
      function fr(e, r) {
        ...
        if (null === r)
          return (
            ...
            this.isSmartPointer
              ? ((t = this.rawConstructor()), null !== e && e.push(this.rawDestructor, t), t)
              : 0
          );
        r.$$ || Ce(`Cannot pass "${Dr(r)}" as a ${this.name}`),
          r.$$.ptr || Ce(`Cannot pass deleted object as a pointer of type ${this.name}`),
        ...
        if (((t = dr(r.$$.ptr, n, this.registeredClass)), this.isSmartPointer))
          switch (
            (void 0 === r.$$.smartPtr && Ce('Passing raw pointer to smart pointer is illegal'),
            this.sharingPolicy)
          ) {
            case 0:
              r.$$.smartPtrType === this
          ...
          var t,
            ...
            a = (e = Te(e)).includes('j')
              ? ((t = e),
                ...
                (o = []),
                function () {
                  return (o.length = 0), Object.assign(o, arguments), Er(t, n, o);
                })
              : wr(r);
          return (
            'function' != typeof a && Ce(`unknown function pointer with signature ${e}: ${r}`), a
          );
        },
        _r = (e, r) => {
          var t = [],
          ...
          throw (
            (r.forEach(function e(r) {
              n[r] || Ue[r] || (rr[r] ? rr[r].forEach(e) : (t.push(r), (n[r] = !0)));
            }),
      ...
      function $r(e, r, t, n, o, a) {
        var i = r.length;
        i < 2 &&
          Ce("argTypes array size mismatch! Must at least get return value and 'this' types!");
        for (var s = null !== r[1] && null !== t, l = !1, u = 1; u < r.length; ++u)
        ...
        return function () {
          var t;
          arguments.length !== c &&
            Ce(`function ${e} called with ${arguments.length} arguments, expected ${c}`),
            (h.length = 0),
            (p.length = s ? 2 : 1),
            (p[0] = o),
            s && ((t = r[1].toWireType(h, this)), (p[1] = t));
          for (var a = 0; a < c; ++a) (f[a] = r[a + 2].toWireType(h, arguments[a])), p.push(f[a]);
      ...
      var kr = (e, r) => {
        ...
        Cr = (e, r, t) => (
          ...
          e.$$.ptr || Ce(`cannot call emscripten binding method ${t} on deleted object`),
        ...
        Tr = 'undefined' != typeof TextDecoder ? new TextDecoder('utf-16le') : void 0,
        Mr = (e, r) => {
        ...
        Ir = () => {
          ...
          function e(e) {
            e.$$$embind_global$$$ = e;
            var r = 'object' == typeof $$$embind_global$$$ && e.$$$embind_global$$$ == e;
      ...
      var Hr = (e) => e % 4 == 0 && (e % 100 != 0 || e % 400 == 0),
        ...
        Vr = (e) => (Hr(e.getFullYear()) ? Br : Yr)[e.getMonth()] + e.getDate() - 1;
      var qr;
      qr = () => performance.now();
      var Xr = (e) => {
      ...
      Object.defineProperties(tt.prototype, {
        ...
        ke.allocated.push({ value: void 0 }, { value: null }, { value: !0 }, { value: !1 }),
      ...
      var at,
        it = {
            ...
            try {
              for (
                var a = 0,
                  ...
                  v = 0,
                  y = 0,
                  g = (r ? k[r >> 2] : 0) | (t ? k[t >> 2] : 0) | (n ? k[n >> 2] : 0),
                  w =
                    (r ? k[(r + 4) >> 2] : 0) |
                    (t ? k[(t + 4) >> 2] : 0) |
                    (n ? k[(n + 4) >> 2] : 0),
                ...
                if (E(b, g, w, _)) {
                  ...
                  if ($.stream_ops.poll) {
                    var P = -1;
                    if (o) P = 1e3 * ((r ? k[o >> 2] : 0) + (r ? k[(o + 8) >> 2] : 0) / 1e6);
                    C = $.stream_ops.poll($, P);
                  }
                  1 & C && E(b, i, s, _) && (b < 32 ? (f |= _) : (p |= _), a++),
                    4 & C && E(b, l, u, _) && (b < 32 ? (h |= _) : (m |= _), a++),
                    2 & C && E(b, d, c, _) && (b < 32 ? (v |= _) : (y |= _), a++);
                }
              }
              return (
                r && ((k[r >> 2] = f), (k[(r + 4) >> 2] = p)),
          ...
          ma: function (e, r, t, n) {
            try {
              if (((r = pe.getStr(r)), (r = pe.calculateAt(e, r)), -8 & t)) return -28;
          ...
          Z: function (e, r, t) {
            try {
              ...
              for (
                var o = 280, a = 0, i = ce.llseek(n, 0, 1), s = Math.floor(i / o);
              ...
              switch (r) {
                ...
                case 21505:
                  ...
                  if (n.tty.ops.ioctl_tcgets) {
                    ...
                    for (var i = 0; i < 32; i++) E[(a + i + 17) >> 0] = o.c_cc[i] || 0;
                    return 0;
                  }
                  return 0;
                case 21506:
          ...
          _: function (e, r, t) {
            try {
              return (
                ...
                '/' === (r = J.normalize(r))[r.length - 1] && (r = r.substr(0, r.length - 1)),
                ce.mkdir(r, t, 0),
                0
              );
            } catch (e) {
          ...
          ca: function (e, r, t, n) {
            try {
              ...
              var o = 256 & n,
                a = 4096 & n;
              return (
                (n &= -6401), (r = pe.calculateAt(e, r, a)), pe.doStat(o ? ce.lstat : ce.stat, r, t)
              );
            } catch (e) {
              if (void 0 === ce || 'ErrnoError' !== e.name) throw e;
              return -e.errno;
            ...
            var n = [].slice,
              ...
              l = ye(e, function () {
                o.baseClass.pureVirtualFunctions.forEach(
                  function (e) {
                    if (this[e] === i[e])
                      throw new Ee(`Pure virtual function ${e} must be implemented in JavaScript`);
                  }.bind(this)
                ),
          ...
          l: (e, r, t, n, o, a, i, s, l, u, d, c, f) => {
            (d = Te(d)), (a = br(o, a)), s && (s = br(i, s)), u && (u = br(l, u)), (f = br(c, f));
            var p = ve(d);
            lr(p, function () {
              ...
              tr([e, r, t], n ? [n] : [], function (r) {
                var t, o;
                (r = r[0]), (o = n ? (t = r.registeredClass).instancePrototype : ir.prototype);
                var i = ye(p, function () {
                    ...
                    if (void 0 === e)
                      throw new we(
                        `Tried to invoke ctor of ${d} with invalid number of parameters (${arguments.length}) - expected (${Object.keys(c.constructor_body).toString()}) parameters instead!`
                      );
                ...
                c.baseClass &&
                  (void 0 === c.baseClass.__derivedClasses && (c.baseClass.__derivedClasses = []),
                  c.baseClass.__derivedClasses.push(c));
                var h = new mr(d, c, !0, !1, !1),
                  m = new mr(d + '*', c, !1, !1, !1),
                  v = new mr(d + ' const*', c, !1, !0, !1);
                return (Ve[e] = { pointerType: m, constPointerType: v }), gr(p, i), [h, m, v];
              });
          },
          F: (e, r, t, n, o, a, i, s) => {
            var l = kr(t, n);
              ...
              tr([], [e], function (e) {
                ...
                return (
                  ...
                  tr(
                    ...
                    (n) => (
                      n.splice(1, 0, null),
                      (e.registeredClass.constructor_body[r - 1] = $r(t, n, null, o, a)),
                      []
                    )
                  ),
                  []
          ...
          d: (e, r, t, n, o, a, i, s, l) => {
            ...
            (r = Te(r)),
              ...
              tr([], [e], function (e) {
                ...
                return (
                  void 0 === d ||
                  (void 0 === d.overloadTable && d.className !== e.name && d.argCount === t - 2)
            ...
            (r = Te(r)),
              ...
              tr([], [e], function (e) {
                ...
                return (
                  ...
                  Object.defineProperty(e.registeredClass.instancePrototype, r, d),
                  tr([], l ? [t, i] : [t], function (t) {
                    ...
                    return Object.defineProperty(e.registeredClass.instancePrototype, r, d), [];
                  }),
                  []
                );
              });
          ...
          e: (e, r, t) => {
            ...
            nr(
              e,
              { name: (t = Te(t)), fromWireType: o, argPackAdvance: or, readValueFromPointer: o },
          ...
          Y: (e, r, t, n, o, a, i, s, l, u, d, c) => {
            (t = Te(t)),
              ...
              (c = br(d, c)),
              tr([e], [r], function (e) {
                return (e = e[0]), [new mr(t, e.registeredClass, !1, !1, !0, e, n, a, s, u, c)];
              });
          },
          D: (e, r) => {
              ...
              fromWireType(e) {
                ...
                if (t)
                  for (var a = o, i = 0; i <= n; ++i) {
                    ...
                    if (i == n || 0 == b[s]) {
                      var l = fe(a, s - a);
                      void 0 === r ? (r = l) : ((r += String.fromCharCode(0)), (r += l)),
                        (a = s + 1);
                    }
                  }
                else {
              ...
              toWireType(e, r) {
                ...
                if (((C[a >> 2] = n), t && o)) me(r, i, n + 1);
                  ...
                  for (var s = 0; s < n; ++s) {
                    ...
                    l > 255 &&
                      (ut(i), Ce('String has UTF-16 code units that do not fit in 8 bits')),
                      (b[i + s] = l);
                  }
          ...
          u: (e, r, t) => {
            ...
            (t = Te(t)),
              2 === r
                ...
                : 4 === r && ((n = Or), (o = Rr), (i = zr), (a = () => C), (s = 2)),
              nr(e, {
                name: t,
                fromWireType: (e) => {
                  for (var t, o = C[e >> 2], i = a(), l = e + 4, u = 0; u <= o; ++u) {
                    var d = e + 4 + u * r;
                    if (u == o || 0 == i[d >> s]) {
                      var c = n(l, d - l);
                      void 0 === t ? (t = c) : ((t += String.fromCharCode(0)), (t += c)),
                        (l = d + r);
                    }
                  }
                  return ut(e), t;
                ...
                toWireType: (e, n) => {
                  'string' != typeof n && Ce(`Cannot pass non-string to C++ string type ${t}`);
                  var a = i(n),
                    l = lt(4 + a + r);
                  return (C[l >> 2] = a >> s), o(n, l + 4, a + r), null !== e && e.push(ut, l), l;
                },
                argPackAdvance: or,
                readValueFromPointer: Qe,
                destructorFunction(e) {
          ...
          ua: (e, r, t, n, o, a) => {
            Ke[e] = { name: Te(r), rawConstructor: br(t, n), rawDestructor: br(o, a), fields: [] };
          },
            ...
            return (
              (i = (r, o, a, i) => {
                for (var s = 0, u = 0; u < e - 1; ++u)
                  (l[u] = t[u + 1].readValueFromPointer(i + s)), (s += t[u + 1].argPackAdvance);
                var d = r[o].apply(r, l);
                for (u = 0; u < e - 1; ++u) t[u + 1].deleteObject && t[u + 1].deleteObject(l[u]);
          ...
          M: function (e, r, t) {
            ...
            (k[t >> 2] = o.getSeconds()),
              ...
              (k[(t + 24) >> 2] = o.getDay());
            var a = 0 | Vr(o);
            (k[(t + 28) >> 2] = a), (k[(t + 36) >> 2] = -60 * o.getTimezoneOffset());
          ...
          $: (e, r) => {
            ...
            return (
              Jr().forEach((n, o) => {
                ...
                (C[(e + 4 * o) >> 2] = a),
                  ((e, r) => {
                    for (var t = 0; t < e.length; ++t) E[r++ >> 0] = e.charCodeAt(t);
                    E[r >> 0] = 0;
                  })(n, a),
                  (t += n.length + 1);
              }),
          ...
          s: (e, r, t, n) => {
            ...
            var v = {
              ...
              '%j': (e) => f(e.tm_mday + Kr(Hr(e.tm_year + 1900) ? Zr : Qr, e.tm_mon - 1), 3),
              '%m': (e) => f(e.tm_mon + 1, 2),
              '%M': (e) => f(e.tm_min, 2),
              '%n': () => '\n',
            ...
            return w.length > r ? 0 : ((y = w), (g = e), E.set(y, g), w.length - 1);
          },
          sa: (e, r, t) => {
            for (var n = fe(r), o = '\\!@#$^&*()+=-[]/{}|:<>?,.', a = 0, i = o.length; a < i; ++a)
            ...
            for (a = n.indexOf('%'); a >= 0; a = n.indexOf('%'))
              c.push(n[a + 1]), (n = n.replace(new RegExp('\\%' + n[a + 1], 'g'), ''));
            var f = new RegExp('^' + n, 'i').exec(fe(e));
            if (f) {
              var p,
                h = (function () {
                  function e(e, r, t) {
                    return 'number' != typeof e || isNaN(e) ? r : e >= r ? (e <= t ? e : t) : r;
                  }
                  return {
              ...
              if (((p = m('S')) && (h.sec = rt(p)), (p = m('M')) && (h.min = rt(p)), (p = m('H'))))
                h.hour = rt(p);
              else if ((p = m('I'))) {
                var v = rt(p);
                (p = m('p')) && (v += 'P' === p.toUpperCase()[0] ? 12 : 0), (h.hour = v);
              }
              if ((p = m('Y'))) h.year = rt(p);
              else if ((p = m('y'))) {
                var y = rt(p);
                (p = m('C')) ? (y += 100 * rt(p)) : (y += y < 69 ? 2e3 : 1900), (h.year = y);
              }
              if (
                ((p = m('m'))
                  ? (h.month = rt(p) - 1)
                ...
                if ((p = m('U'))) {
                  var $ = { SUN: 0, MON: 1, TUE: 2, WED: 3, THU: 4, FRI: 5, SAT: 6 }[_],
                    C = rt(p);
                  (D =
                  ...
                  var P, D;
                  ($ = { MON: 0, TUE: 1, WED: 2, THU: 3, FRI: 4, SAT: 5, SUN: 6 }[_]), (C = rt(p));
                  (D =
              ...
              return (
                ...
                (k[(t + 24) >> 2] = F.getDay()),
                (k[(t + 28) >> 2] =
                  Kr(Hr(F.getFullYear()) ? Zr : Qr, F.getMonth() - 1) + F.getDate() - 1),
                (k[(t + 32) >> 2] = 0),
                e + oe(f[0]).length - 1
              );
            }
        ...
        st = (function () {
          ...
          function s(e, r) {
            var t;
            return (
              (st = e.exports), (w = st.va), T(), (vr = st.Ca), (t = st.wa), A.unshift(t), U(), st
            );
          }
          if ((N(), o.instantiateWasm))
            try {
              ...
              g(`Module.instantiateWasm callback failed with error: ${e}`), n(e);
            }
          return (
            ((e = v),
            (r = I),
        ...
        ct = (e) => (ct = st.Aa)(e),
        ft =
          ((o.__embind_initialize_bindings = () => (o.__embind_initialize_bindings = st.Ba)()),
          (e, r) => (ft = st.Da)(e, r)),
        pt = () => (pt = st.Ea)(),
        ht = (e) => (ht = st.Fa)(e);
      (o.dynCall_jiji = (e, r, t, n, a) => (o.dynCall_jiji = st.Ga)(e, r, t, n, a)),
        (o.dynCall_ji = (e, r) => (o.dynCall_ji = st.Ha)(e, r)),
        (o.dynCall_viij = (e, r, t, n, a) => (o.dynCall_viij = st.Ia)(e, r, t, n, a)),
        (o.dynCall_iij = (e, r, t, n) => (o.dynCall_iij = st.Ja)(e, r, t, n)),
        (o.dynCall_iiji = (e, r, t, n, a) => (o.dynCall_iiji = st.Ka)(e, r, t, n, a)),
        (o.dynCall_jji = (e, r, t, n) => (o.dynCall_jji = st.La)(e, r, t, n)),
        (o.dynCall_iji = (e, r, t, n) => (o.dynCall_iji = st.Ma)(e, r, t, n)),
        (o.dynCall_viijj = (e, r, t, n, a, i, s) => (o.dynCall_viijj = st.Na)(e, r, t, n, a, i, s)),
        (o.dynCall_iiij = (e, r, t, n, a) => (o.dynCall_iiij = st.Oa)(e, r, t, n, a)),
        ...
        (o.dynCall_iiiij = (e, r, t, n, a, i) => (o.dynCall_iiiij = st.Ta)(e, r, t, n, a, i)),
...
'object' == typeof exports && 'object' == typeof module
  ...
  : 'function' == typeof define && define.amd && define([], () => PSPDFModuleInit);
