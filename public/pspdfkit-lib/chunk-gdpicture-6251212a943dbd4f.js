  ...
  [1305],
  {
    90027: (e, t, r) => {
      ...
      function _(e) {
        ...
        const a = JSON.stringify(l({ type: e }, t)),
          i = JSON.parse(h.CommandHandler(a));
      ...
      class y {
          ...
          const { Assemblies: l, Module: c } = await (async function (e, t) {
            if ('string' == typeof e) {
              const r = 'pspdfkit-lib/',
                s = `${r}gdpicture-2df8622a/jit`,
                n = `${r}gdpicture-2df8622a/aot`;
              let o, a;
              t
                ? ((o = `${e}${n}/initDotnet.js`), (a = `${e}${n}`))
                : ((o = `${e}${s}/initDotnet.js`), (a = `${e}${s}`));
              const { initDotnet: i } = await import(o);
              return i(a);
            }
            throw new Error('GdPicture WASM loader not implemented');
          })(e, t);
          (h = l.GdPictureWasm.API),
            (w = c),
            _('gdpicture/setLicense', { origin: r }, { licenseKey: s || 'DEMO_PSPDFKIT_WEB' });
          const u = n ? '/fonts' : '';
          if (
            (n &&
              !w.FS.analyzePath(u).exists &&
              (this._mountCustomFonts(n, u), _('gdpicture/setFonts', { fontPaths: [u] })),
            a)
          ) {
        ...
        toPdf(e, t) {
          ...
          try {
            return (
              _('gdpicture/process', { input: { file: c }, output: r }), w.FS.readFile(u).buffer
            );
          } finally {
            try {
              w.FS.unlink(u);
        ...
        toOffice(e, t) {
          ...
          try {
            return (
              _('gdpicture/process', { input: { file: c }, output: { file: r, format: t } }),
        ...
        async populateDocumentTemplate(e, t) {
          ...
          try {
            return (
              _('gdpicture/process-office-template', {
                inputFile: d,
      ...
      const g = class {
        constructor(e) {
          ...
          (0, s.Z)(this, 'requests', new Map()),
            (0, s.Z)(this, 'nextRequestId', 1),
            (0, s.Z)(this, 'handleMessage', (e) => {
              const t = e.data,
                r = this.requests.get(t.id);
        ...
        toPdf(e, t) {
          let r;
          return (
            t && (r = t.replace('pdf', 'pdf_').replaceAll('-', '_')),
            this.sendRequest('toPdf', [e, r])
          );
        }
        async populateDocumentTemplate(e, t) {
        ...
        destroy() {
          var e;
          null === (e = this.workerSpawner) || void 0 === e || e.terminate(),
            (this.workerSpawner = null);
        }
        async sendRequest(e, t) {
          (0, n.kG)(this.workerSpawner, 'GdPictureClient has been destroyed'),
            this.moduleLoadPromise && (await this.moduleLoadPromise);
          const r = this.workerSpawner;
          return new Promise((s, n) => {
            const o = this.assignId(),
              a = [...t].filter((e) => e instanceof ArrayBuffer);
            r.postMessage({ id: o, action: e, args: t }, a),
              (this.requests = this.requests.set(o, { resolve: s, reject: n }));
          });
        }
        assignId() {
