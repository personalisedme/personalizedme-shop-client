  ...
  [6377],
  {
        ...
        request() {
          return new Promise((e, t) => {
            ...
            (this.httpRequest = n),
              ...
              n.setRequestHeader('PSPDFKit-Version', (0, S.oM)()),
                ...
                if (n.response && n.response.type.startsWith('application/json')) {
                  ...
                  return (
                    (r.onload = (n) => {
                      var r;
                      const s = JSON.parse(
                        null === (r = n.target) || void 0 === r ? void 0 : r.result
                      );
                      s.attachments_not_found
                        ? e({ attachmentsNotFound: s.attachments_not_found })
                        : s.error
                          ? 'initialization_error' === s.error
                            ? e(null)
                            : t(
                                new o.p2(
                                  `The server could not render the requested image (${s.error})`
                                )
                              )
                          : t(new o.p2(P));
                    }),
                    (r.onerror = () => t(new o.p2(P))),
                    void r.readAsText(n.response)
                  );
                }
      ...
      class J extends C.W {
        constructor(e) {
          ...
          if (
            ...
            (0, s.Z)(this, '_requestRenderAnnotation', (e, n, r, s, i, a) => {
              const h = `${this._state.documentURL}/render_annotation`,
                c = `render-annotation-${a ? (0, l.SK)() : e.id}`,
                u = JSON.stringify({
                  data: (0, m.Hs)(e),
                  width: s,
                  height: i,
                ...
                (function n() {
                  ...
                  l.append('render', u),
                    a.length > 0 &&
                      ...
                      e.imageAttachmentId &&
                      r &&
                      l.append(e.imageAttachmentId, r);
                  const m = new I({
                      identifier: c,
                      url: h,
                  ...
                  g.promise
                    .then((e) => {
                      p ||
                        (null != e && e.attachmentsNotFound
                          ? n(e.attachmentsNotFound)
                          : null != e && e.attachmentsNotFound
                            ? f.reject(new o.p2('Attachment could not be found.'))
                            : f.resolve(e));
                    })
                    .catch((e) => {
                      p || f.reject(e);
          ...
          let h = null,
            c = null,
            u = null;
          if (i) (u = e.hostedBaseUrl || 'https://api.pspdfkit.com/'), (0, w.sf)(u), (0, f.eU)(i);
          else {
            if (
              ((h = (function (e) {
                ...
                if (!e.serverUrl) {
                  if (n === `${t.location.protocol}//${t.location.host}/`)
                    throw new o.p2(
              ...
              throw new o.p2('`documentId` must be of type string.');
            if (
              ((c = `${h}i/d/${e.documentId}`),
              'object' != typeof e.authPayload ||
        ...
        async load() {
            ...
            return r.ok
              ...
              : r.text().then((e) => {
                  throw 'INVALID_PASSWORD' === e
                    ? new o.p2(e)
                    : new o.p2(
                        `An error occurred while connecting to PSPDFKit Document Engine: ${e || r.statusText}`
                      );
                });
          })(
          ...
          const R = (0, h.valid)((0, h.coerce)(y)),
            P = (0, h.valid)((0, h.coerce)($));
          if (y && (0, h.lt)(R || '', '2023.5.0'))
            throw new o.p2(`Server version ${y} does not meet minimum required version 2023.5.0`);
          if ($ && (0, h.lt)(P || '', '1.0.0'))
            throw new o.p2(
              `Document Engine version ${$} does not meet minimum required version 1.0.0`
            );
          if (this._state.instantSettings && !s.includes(M.q.INSTANT))
            throw new o.p2(
              'Instant feature is not enabled on this server. Please set `instant` to `false`.\n\nFor more information about PSPDFKit Instant please visit:\nhttps://pspdfkit.com/guides/web/current/instant/overview/'
            );
          const I =
            a === E.H.ELECTRONIC_SIGNATURES &&
            (0, G.Vz)(s) &&
            this._state.forceLegacySignaturesFeature
              ? E.H.LEGACY_SIGNATURES
              : a;
          if (
            ((this._state = this._state.withMutations((e) =>
              e
                .set('imageToken', t)
                .set('token', n)
                .set('features', (0, i.aV)(s))
                .set('signatureFeatureAvailability', I)
                .set(
                  'backendPermissions',
                  new L.Z({
                ...
                .set('documentURL', `${this._state.serverUrl}i/d/${this._state.documentId}/h/${p}`)
                .set('documentHandle', p)
                .set('isDocumentHandleOutdated', !1)
                .set('digitalSignatures', (0, m.rS)(f))
            )),
            (this.corePDFBridge = new V.V(
              c.f.createServerContext({
              ...
              t = this._state.authPayload.accessToken,
              {
                ...
                const n = await fetch(`${e}i/documents/auth`, {
                  ...
                  headers: {
                    ...
                    'PSPDFKit-Platform': 'web',
                    'PSPDFKit-Version':
                      'cloud-protocol=1, server-protocol=5, client=2024.4.0, client-git=ffbc8fcc48'
                  },
        ...
        async _initProvider() {
          if (this._state.instantSettings) {
            const e = `${this._state.serverUrl}i/d/${this._state.documentId}/h/${this._state.documentHandle}`,
              { InstantProvider: t } = await n.e(2333).then(n.bind(n, 36344));
            return new t(
              `${this._state.serverUrl}i/d/${this._state.documentId}`,
              e,
          ...
          {
            const e = this._state.isFormsEnabled && this._state.features.includes(M.q.FORMS),
              { RESTProvider: t } = await n.e(4099).then(n.bind(n, 87629));
            return new t(
        ...
        getFormJSON() {
          return this._fetch(`${this._state.documentURL}/form.json`).then((e) =>
            403 === e.status
        ...
        textForPageIndex(e) {
          ...
          return {
            promise: r.promise.then((t) => (0, A.TH)(t, e)),
            cancel: () => {
              r.cancel();
            }
          };
        ...
        getTextFromRects(e, t) {
          ...
          return this._fetch(`${this._state.documentURL}/page-${e}-highlighted?rects=${n}`)
            .then((e) => e.json())
            .then((e) => e.text);
        }
          ...
          const a = new Promise((t, r) => {
            const s = o.filter(
              ...
              { promise: a, cancel: l } = this._requestRenderAnnotations(
                ...
                s.map((e) => Math.floor(e.boundingBox.width * n)).toArray(),
                s.map((e) => Math.floor(e.boundingBox.height * n)).toArray(),
                i
              );
            a.then((e) => {
        ...
        async search(e, t, n, r) {
          ...
          const o = `q=${i === D.S.PRESET ? e.replace(/_/g, '-') : encodeURIComponent(e)}&start=${t}&limit=${n}&type=${i}&include_annotations=${s.toString()}&case_sensitive=${r.toString()}`,
            ...
            l = await new g.Z(a, this._state.token).request();
          return (0, p.E)(l.data);
        }
        ...
        async searchAndRedact(e, t) {
          const {
              searchType: n,
              annotationPreset: s,
              searchInAnnotations: o,
              caseSensitive: a
            } = t,
            { color: l, fillColor: h, outlineColor: c } = s,
            u = (0, r.Z)(s, B),
            p = await this._fetch(`${this._state.documentURL}/redactions`, {
              ...
              body: JSON.stringify({
                ...
                content: K(
                  K({}, u),
                  {},
                  { color: l && l.toHex(), fillColor: h && h.toHex(), outlineColor: c && c.toHex() }
                )
              })
            }),
            { data: d } = await p.json();
          return (0, i.aV)(
            d && d.annotations ? d.annotations.map((e) => F.Z.fromJSON(e.id, e.content)) : []
          );
        }
        exportPDF() {
          let {
        ...
        generatePDFObjectURL() {
          let e,
            { includeComments: t = !0, excludeAnnotations: n = !1 } =
              arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
            r = !1;
          return {
            promise: new Promise((s) => {
              this.exportPDF({ flatten: !0, includeComments: t, excludeAnnotations: n }).then(
                (t) => {
                  if (r) return;
        ...
        async getDocumentOutline() {
          let e;
          try {
            e = (await this._fetch(`${this._state.documentURL}/outline.json`).then((e) => e.json()))
              .data;
          } catch (t) {
            e = {};
          }
        ...
        async getMeasurementScales() {
          ...
          try {
            return (
              (e = (
                await this._fetch(`${this._state.documentURL}/measurement_content_formats`).then(
                  (e) => e.json()
                )
              ).data),
              e
        ...
        async getSecondaryMeasurementUnit() {
          ...
          try {
            return (
              (e = (
                await this._fetch(`${this._state.documentURL}/secondary_measurement_unit`).then(
                  (e) => e.json()
                )
              ).data),
              e
            ...
            this._refreshSignaturesInfoPromise ||
              (this._refreshSignaturesInfoPromise = new Promise((e, t) => {
                this._fetch(`${this._state.documentURL}/signatures`, {
                  ...
                  .then((t) => {
                    let { data: n } = t;
                    (this._state = this._state.set('digitalSignatures', (0, m.rS)(n))),
        ...
        async signDocumentAndReload(e, t) {
          ...
          try {
            ...
            if (void 0 !== t && 'object' != typeof t)
              throw new o.p2('Signing service data must be an object if specified.');
            (0, q.tK)(e);
            const s = e
                ? K(
                    K(
                        ...
                        K(
                          K(
                            K(
                              ...
                              null != e && e.signatureMetadata
                                ? { signatureMetadata: (0, m._D)(e.signatureMetadata) }
                                : null
                            ),
                            'position' in e ? { position: (0, m.eE)(e.position) } : null
                          ),
                          'appearance' in e ? { appearance: await (0, m.sr)(e.appearance) } : null
                        ),
                        'formFieldName' in e ? { formFieldName: e.formFieldName } : null
                      ),
                      void 0 !== (null == e ? void 0 : e.signingData) &&
                    ...
                    void 0 !== (null == e ? void 0 : e.signingData) &&
                      ...
                      ? { signatureType: m.YA[e.signingData.signatureType] }
                      : null
                  )
                : null,
              i =
                (null == e || null === (n = e.appearance) || void 0 === n
                  ? void 0
                  : n.watermarkImage) || null,
              a =
                (null == e || null === (r = e.appearance) || void 0 === r
                  ? void 0
                  : r.graphicImage) || null,
              l = K(K({}, t ? { signingToken: t.signingToken } : null), s),
              h = new FormData();
            if (
              (h.append('data', JSON.stringify(l)),
              i && h.append('image', i),
              a && h.append('graphicImage', a),
              this._destroyProvider(),
              ...
              null != e && e.formFieldName)
            )
              return e.formFieldName;
          } catch (e) {
            throw (
              (this.provider.load(), new o.p2(`Adding digital signature failed: ${e.message || e}`))
            );
          }
        }
        ...
        async getEmbeddedFiles() {
          ...
          return (0, i.aV)(
            null != n &&
              null !== (e = n.data) &&
              void 0 !== e &&
              null !== (e = e.embeddedFiles) &&
              void 0 !== e &&
              e.length
              ? n.data.embeddedFiles.map((e) => {
    ...
    22257: (e, t, n) => {
      ...
      class s {
        ...
        test(e) {
          if ((h('Comparator.test', e, this.options.loose), this.semver === r || e === r))
            return !0;
          if ('string' == typeof e)
            try {
    ...
    66902: (e, t, n) => {
      class r {
        constructor(e, t) {
          ...
          if (this.set.length > 1) {
            const e = this.set[0];
            if (((this.set = this.set.filter((e) => !g(e[0]))), 0 === this.set.length))
              this.set = [e];
        ...
        parseRange(e) {
          const t = ((this.options.includePrerelease && m) | (this.options.loose && f)) + ':' + e,
            n = s.get(t);
          if (n) return n;
          const r = this.options.loose,
            i = r ? h[c.HYPHENRANGELOOSE] : h[c.HYPHENRANGE];
          (e = e.replace(i, _(this.options.includePrerelease))),
            a('hyphen replace', e),
            (e = e.replace(h[c.COMPARATORTRIM], u)),
            a('comparator trim', e),
            (e = e.replace(h[c.TILDETRIM], p)),
            a('tilde trim', e),
            (e = e.replace(h[c.CARETTRIM], d)),
            a('caret trim', e);
          let l = e
            .split(' ')
          ...
          r &&
            (l = l.filter(
              (e) => (a('loose invalid filter', e, this.options), !!e.match(h[c.COMPARATORLOOSE]))
            )),
            a('range list', l);
          const E = new Map(),
        ...
        intersects(e, t) {
          ...
          return this.set.some(
            (n) =>
              v(n, t) &&
              e.set.some((e) => v(e, t) && n.every((n) => e.every((e) => n.intersects(e, t))))
          );
        }
        test(e) {
          if (!e) return !1;
      ...
      const s = new (n(96062))({ max: 1e3 }),
        ...
        { FLAG_INCLUDE_PRERELEASE: m, FLAG_LOOSE: f } = n(83295),
        g = (e) => '<0.0.0-0' === e.value,
        E = (e) => '' === e.value,
        v = (e, t) => {
          let n = !0;
              ...
              y(n)
                ...
                : y(r)
                  ...
                  : y(s)
                    ? (o = `>=${n}.${r}.0 <${n}.${+r + 1}.0-0`)
                    : i
                      ? (a('replaceTilde pr', i), (o = `>=${n}.${r}.${s}-${i} <${n}.${+r + 1}.0-0`))
                      : (o = `>=${n}.${r}.${s} <${n}.${+r + 1}.0-0`),
              a('tilde return', o),
              o
            );
        ...
        P = (e, t) => {
          a('caret', e, t);
          const n = t.loose ? h[c.CARETLOOSE] : h[c.CARET],
              ...
              h
                ...
                : r && p
                  ? (c && (i = 0),
                    (o = 0),
                    '>' === r
                      ? ((r = '>='), c ? ((s = +s + 1), (i = 0), (o = 0)) : ((i = +i + 1), (o = 0)))
                      : '<=' === r && ((r = '<'), c ? (s = +s + 1) : (i = +i + 1)),
                    '<' === r && (l = '-0'),
                    (n = `${r + s}.${i}.${o}${l}`))
                  : c
                    ? (n = `>=${s}.0.0${l} <${+s + 1}.0.0-0`)
                    : u && (n = `>=${s}.${i}.0${l} <${s}.${+i + 1}.0-0`),
              a('xRange return', n),
              n
            );
          });
        ...
        O = (e, t) => (
          a('replaceGTE0', e, t), e.trim().replace(h[t.includePrerelease ? c.GTE0PRE : c.GTE0], '')
        ),
        _ = (e) => (t, n, r, s, i, o, a, l, h, c, u, p, d) =>
          `${(n = y(r) ? '' : y(s) ? `>=${r}.0.0${e ? '-0' : ''}` : y(i) ? `>=${r}.${s}.0${e ? '-0' : ''}` : o ? `>=${n}` : `>=${n}${e ? '-0' : ''}`)} ${(l = y(h) ? '' : y(c) ? `<${+h + 1}.0.0-0` : y(u) ? `<${h}.${+c + 1}.0-0` : p ? `<=${h}.${c}.${u}-${p}` : e ? `<${h}.${c}.${+u + 1}-0` : `<=${l}`)}`.trim(),
        N = (e, t, n) => {
    ...
    26376: (e, t, n) => {
      const r = n(74225),
        { MAX_LENGTH: s, MAX_SAFE_INTEGER: i } = n(83295),
        { safeRe: o, t: a } = n(55765),
        l = n(12893),
        { compareIdentifiers: h } = n(86742);
      class c {
        constructor(e, t) {
    ...
    55765: (e, t, n) => {
      const { MAX_SAFE_COMPONENT_LENGTH: r, MAX_SAFE_BUILD_LENGTH: s, MAX_LENGTH: i } = n(83295),
        o = n(74225),
        a = ((t = e.exports = {}).re = []),
        l = (t.safeRe = []),
        h = (t.src = []),
      ...
      const p = '[a-zA-Z0-9-]',
        ...
        m = (e, t, n) => {
          ...
          o(e, s, t),
            (c[e] = s),
            (h[s] = t),
            (a[s] = new RegExp(t, n ? 'g' : void 0)),
            (l[s] = new RegExp(r, n ? 'g' : void 0));
        };
      m('NUMERICIDENTIFIER', '0|[1-9]\\d*'),
        ...
        m('PRERELEASEIDENTIFIER', `(?:${h[c.NUMERICIDENTIFIER]}|${h[c.NONNUMERICIDENTIFIER]})`),
        m(
          'PRERELEASEIDENTIFIERLOOSE',
          `(?:${h[c.NUMERICIDENTIFIERLOOSE]}|${h[c.NONNUMERICIDENTIFIER]})`
        ),
        m('PRERELEASE', `(?:-(${h[c.PRERELEASEIDENTIFIER]}(?:\\.${h[c.PRERELEASEIDENTIFIER]})*))`),
        m(
          'PRERELEASELOOSE',
          `(?:-?(${h[c.PRERELEASEIDENTIFIERLOOSE]}(?:\\.${h[c.PRERELEASEIDENTIFIERLOOSE]})*))`
        ),
        m('BUILDIDENTIFIER', '[a-zA-Z0-9-]+'),
        m('BUILD', `(?:\\+(${h[c.BUILDIDENTIFIER]}(?:\\.${h[c.BUILDIDENTIFIER]})*))`),
        m('FULLPLAIN', `v?${h[c.MAINVERSION]}${h[c.PRERELEASE]}?${h[c.BUILD]}?`),
        m('FULL', `^${h[c.FULLPLAIN]}$`),
        m('LOOSEPLAIN', `[v=\\s]*${h[c.MAINVERSIONLOOSE]}${h[c.PRERELEASELOOSE]}?${h[c.BUILD]}?`),
        ...
        m('COMPARATORTRIM', `(\\s*)${h[c.GTLT]}\\s*(${h[c.LOOSEPLAIN]}|${h[c.XRANGEPLAIN]})`, !0),
        (t.comparatorTrimReplace = '$1$2$3'),
        m('HYPHENRANGE', `^\\s*(${h[c.XRANGEPLAIN]})\\s+-\\s+(${h[c.XRANGEPLAIN]})\\s*$`),
        m(
          'HYPHENRANGELOOSE',
    ...
    96062: (e, t, n) => {
      ...
      e.exports = class {
        ...
        reset() {
          this[h] && this[u] && this[u].length && this[u].forEach((e) => this[h](e.key, e.value)),
            (this[p] = new Map()),
            (this[u] = new r()),
            (this[i] = 0);
        }
          ...
          if (
            (r.forEach((e) => {
              e.semver === i && (e = new s('>=0.0.0')),
                (o = o || e),
                (a = a || e),
                d(e.semver, o.semver, p) ? (o = e) : f(e.semver, a.semver, p) && (a = e);
            }),
