      ...
      class p {
        constructor(t, e, a) {
          ...
          (0, o.Z)(this, 'canCreateBackendOrphanWidgets', !0),
            ...
            (this.state = new l({ serverURL: t, authPayload: e, isFormsEnabled: s })),
        ...
        async createAnnotation(t, e) {
          ...
          const a = (0, n.Hs)(t),
            { id: o } = a,
            i = { id: o, content: (0, s.Z)(a, m) },
            d = await this._request('/annotations', 'POST', i);
          if (200 !== d.status)
            throw new r.p2(
              'PSPDFKit Document Engine returned an error, when saving an annotation.'
            );
          if ('attachment_missing' === (await d.json()).error) {
        ...
        async updateAnnotation(t) {
          ...
          const e = (0, n.Hs)(t),
            { id: a } = e,
            o = (0, s.Z)(e, k);
          await this._request(`/annotations/${a}`, 'PUT', { id: a, content: o });
        }
        async deleteAnnotation(t) {
          this._verifyLoaded(), await this._request(`/annotations/${t.id}`, 'DELETE');
        }
        async createBookmark(t) {
          ...
          const e = (0, d.a)(t),
            { id: a } = e,
            o = (0, s.Z)(e, y);
          if (200 !== (await this._request('/bookmarks', 'POST', { id: a, content: o })).status)
            throw new r.p2('PSPDFKit Document Engine returned an error, when saving an bookmark.');
        }
        ...
        async setFormFieldValue(t) {
          ...
          await this._request('/form-field-values', 'POST', { formFieldValues: [e] });
        }
        ...
        async loadAnnotationsForPageIndex(t) {
          if ((this._verifyLoaded(), this.state.alreadyLoadedPages.has(t)))
            ...
            try {
              ...
              const a = await e;
              this.state = this.state.setIn(['alreadyLoadedPages', t], Promise.resolve());
              ...
              s.size > 0 &&
                ...
                this.annotationCallbacks.createAnnotations(s, (0, i.D5)(), h.y));
            } catch (t) {
          ...
          if ((this._verifyLoaded(), this.state.loadBookmarksPromise))
            ...
            try {
              ...
              (this.state = this.state.set('loadBookmarksPromise', Promise.resolve())),
                (0, r.kG)(Array.isArray(e.bookmarks), 'Unexpected reply from bookmarks endpoint.');
              const a = (0, i.aV)().withMutations((t) => {
                e.bookmarks.forEach((e) => {
                  try {
                    t.push((0, d.i)(e.id, e.content));
                  } catch (t) {
                    (0, r.um)(
              ...
              a.size > 0 &&
                ((0, r.kG)(this.bookmarkCallbacks), this.bookmarkCallbacks.createBookmarks(a, h.y));
            } catch (t) {
        ...
        _request(t, e, a) {
          (0, r.kG)(null != this.state.authPayload, 'Cannot call request without authPayload');
          const s =
          ...
          return fetch(`${this.state.serverURL}${t}`, {
            method: e,
            headers: i,
            body: a instanceof FormData ? a : 'object' == typeof a ? JSON.stringify(a) : void 0,
            credentials: 'include'
          });
        }
        _verifyLoaded() {
        ...
        async updateTabOrder() {
          throw new r.p2('Tab order is not supported on this backend.');
        }
        async setTabOrder() {
          throw new r.p2('setTabOrder is not supported on this backend.');
        }
      }
    }
  }
