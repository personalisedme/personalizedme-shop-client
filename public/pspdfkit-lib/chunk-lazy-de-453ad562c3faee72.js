...
(self.webpackChunkPSPDFKit = self.webpackChunkPSPDFKit || []).push([
  [4572],
  {
    29332: (e, t, a) => {
          ...
          return t.map((e, t) => {
            ...
            if ('move' === e.type && d)
              return n.createElement(
                'div',
                { key: d.type, className: i.moveButtonContainer },
                n.createElement(
                  l,
                  (0, N.Z)({}, d, {
                    icon: a(6058),
            ...
            if ('custom' === e.type && e.node) {
              ...
              return n.createElement(
                k.Z,
                (0, N.Z)({}, o, { onPress: null == c ? void 0 : c(e), key: e.id || t })
              );
            }
            return n.createElement(
              l,
              (0, N.Z)({}, e, { key: (d && d.type) || t, onPress: null == c ? void 0 : c(e) })
            );
          });
        }),
        M = (0, n.memo)((e) => {
          let {
            ...
            builtInItems: o,
            CSS_HACK: {
              components: { ToolbarDropdownGroupComponent: s, ToolbarButtonComponent: l },
              styles: i
            },
            frameWindow: c,
            ...
            return n
              ? {
                  ...
                  item: S(
                    ...
                    {},
                    {
                      className: r()(n.className, t.className),
                      onPress: (e) => {
          ...
          return (
            ...
            n.createElement(
              n.Fragment,
              null,
              n.createElement('div', { style: { flex: 1 }, key: 'spacer-responsive' }),
              n.createElement(s, {
      ...
      const B = 'disable-zoom-in',
        L = 'disable-zoom-out',
        R = new P.$u({ width: g.zA, height: g._2 });
      function G(e, t, a) {
      ...
      const T = (e) => {
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(h.Z, { src: a(48982) })
            ),
            n.createElement('span', { className: t.importedDocumentInfo }, o(W.documentMergedHere))
          );
        },
        Z = (e, t, a) => {
          const o = t.flatten();
            ...
            switch (e.type) {
              ...
              case 'rotatePages':
                for (const t of e.pageIndexes) {
                  ...
                  if (
                    ...
                    if ('newPage' !== a.type)
                      throw new d.p2('Rotation is not allowed on imported documents');
                    o = K(K({}, a), {}, { rotation: s });
                  }
                  n = n.set(t, o);
                }
              ...
              case 'duplicatePages': {
                ...
                for (const e of t) {
                  ...
                  n = n.insert(
                    o + 1,
                    Object.assign({}, e, { label: `${a} (${t})`, dupeOf: a, dupeNumber: t })
                  );
                }
                break;
              }
              case 'movePages': {
                ...
                if (1 === t.length) {
                  ...
                  null != e.beforePageIndex
                    ? (o = e.beforePageIndex)
                    : ((0, d.kG)(null != e.afterPageIndex), (o = e.afterPageIndex + 1));
                  const s = n.get(a);
                  (0, d.kG)(null != s);
                  const r = n.get(o),
                    l = n.size;
                  (n = n.delete(a)),
                    o === l
                      ...
                      : 0 === o
                        ? (n = n.unshift(s))
                        : ((0, d.kG)(null != r), (n = n.insert(n.indexOf(r), s)));
                } else {
                  ...
                  if (null != e.beforePageIndex) {
                    ...
                    for (const e of t)
                      (0, d.kG)(null != e), (n = n.delete(n.indexOf(e))), (n = n.unshift(e));
                  } else {
                    ...
                    for (const e of o)
                      (0, d.kG)(null != e),
                        (n = n.delete(n.indexOf(e))),
                        (n = n.insert(n.indexOf(t) + 1, e));
                  }
                }
                break;
              }
              case 'importDocument': {
                ...
                'beforePageIndex' in e && null != e.beforePageIndex
                  ...
                  'string' != typeof e.document
                    ? ((0, d.kG)('string' == typeof e.document.name), (a = e.document.name))
                    : (a = e.document),
                  (n = n.insert(t, { type: 'importedDocument', label: a }));
                break;
              }
            }
          return n;
        ...
        j = (e) => {
          ...
          return n.createElement(
            'div',
            { className: o.movePreview },
            n.createElement(
              'div',
              { className: r()(o.movePreviewPages, { [o.movePreviewPagesLoose]: 'loose' === a }) },
              t
            ),
            n.createElement('div', { className: o.movePreviewCount }, s || t.length)
          );
        },
        H = (e) => {
          const { onCancel: t, onDialog: o, usesShadowDOM: s } = e,
            ...
            S = (0, c.I0)(),
            { formatMessage: F } = (0, i.YB)(),
            { styles: H } = e.CSS_HACK,
            [$, _] = (0, n.useState)((0, l.aV)()),
            [V, U] = (0, n.useState)(0),
            Y = $.slice(0, $.size - V),
            J = Z(E, Y, F),
            [X, q] = (0, n.useState)((0, l.l4)()),
            [Q, ee] = (0, n.useState)(!1),
            ...
            [le, ie] = (0, n.useState)(''),
            { zoomStep: ce } = (0, c.v9)((e) => e.viewportState),
            {
              thumbnailDefaultSize: de,
              thumbnailMinSize: me,
              thumbnailMaxSize: ue
            } = (0, c.v9)((e) => e.documentEditorConfig),
            [ge, pe] = (0, n.useState)(() => G(de, me, ue)),
            [fe, Pe] = (0, n.useState)(''),
            ye = (0, n.useCallback)(() => {
              const e = ne.current;
              null != e &&
          ...
          const Ie = (0, n.useCallback)(() => {
            ...
            Te = (0, n.useCallback)(async () => {
              ee(!0);
              try {
                const e = await N.exportPDFWithOperations(
                  Y.flatten()
                    .toArray()
                    .map(y.kg)
                    .concat([{ type: 'keepPages', pageIndexes: X.toArray() }])
                );
                (0, f.cR)(e, D);
              } catch (e) {
                throw e;
            ...
            Xe = !X.isEmpty() && X.size !== J.size && !Q,
            qe = !X.isEmpty() && !X.includes(0),
            Qe = !X.isEmpty() && !X.includes(J.size - 1),
            et = V < $.size,
            tt = V > 0,
            at = X.size < J.size && !Q,
            ot = !X.isEmpty() && !Q,
            nt = (0, n.useRef)(null),
            st = (0, n.useRef)(!1),
            [rt, lt] = (0, n.useState)(new P.$u()),
            [it, ct] = (0, n.useState)(Number.POSITIVE_INFINITY),
            dt = (0, n.useCallback)(
              (e) => {
                lt(
                  (t) => (
                    t.width !== e.width && ct(Number.POSITIVE_INFINITY),
          ...
          (0, n.useLayoutEffect)(() => {
            ...
            const n = [].findIndex.call(
              t,
              (e, t) => 'spacer' !== x[t].type && ((o += e.clientWidth), o > rt.width)
            );
          ...
          (0, n.useLayoutEffect)(() => {
            ...
            const t = (e) => {
              if (null != document.activeElement && 'INPUT' === document.activeElement.tagName)
                return;
              if (Q) return;
              ...
              if (e.altKey && e.shiftKey && !a && 'arrowleft' === t && Ye) Ee();
              else if (e.altKey && e.shiftKey && !a && 'arrowright' === t && Ye) Ne();
              else if (n && 'arrowleft' === t && qe) Ke();
              else if (n && 'arrowright' === t && Qe) Be();
              else if (a && e.shiftKey && !e.altKey && 'z' === t && tt) Re();
              else if (o && 'z' === t && et) Le();
              else if (o && 'a' === t && at) Ze();
              else if (o && 'd' === t && ot) je();
              else if (!o || ('=' !== t && '+' !== t))
                if (o && '-' === t) ut(), e.stopPropagation();
                else if (o && '0' === t) gt(), e.stopPropagation();
                else if (s && 'n' === t) Ie();
                else if (s && 'd' === t && Ue) we();
                else if (s && 'c' === t && Je) ke();
                else if (s && 'l' === t && Ye) Ee();
                else if (s && 'r' === t && Ye) Ne();
                else if (s && 'm' === t && Xe) be(!0);
                else {
                  if (!s || 'i' !== t) return;
                  Ge();
                }
          ...
          const ft = H.toolbar.toolbarButton,
            Pt = [
              { type: 'add', onPress: Ie, className: ft, disabled: Q, children: F(W.newPage) },
              {
                type: 'remove',
                onPress: we,
                className: ft,
            ...
            It = (0, n.useMemo)(() => null != yt.find((e) => 'move' === e.type), [yt]),
            wt = n.createElement(
              'div',
              {
                className: r()(
                  H.moveDialog,
                  { [H.moveDialogShown]: se, [H.moveDialogDetached]: !It },
              ...
              n.createElement(
                'form',
                { onSubmit: Ae, className: H.moveDialogForm },
                n.createElement('span', { className: H.moveDialogFormLabel }, F(W.insertAfterPage)),
                ...
                n.createElement(
                  m.zx,
                  { type: 'submit', className: H.moveDialogMoveButton, disabled: !Me },
                  F(W.move)
                )
              ),
              n.createElement(
                ...
                n.createElement(
                  ...
                  F(W.docEditorMoveBeginningHint)
                )
              )
            ),
            kt = (0, n.useCallback)(
            ...
            Nt &&
              ((Et =
                0 === xe
                  ...
                  : { previewContent: t, pageIndex: xe - 1, position: 'right' }),
              Me || (Et.disabled = !0));
          }
                ...
                'selected-pages': {
                  element: n.createElement(
                    ...
                    n.createElement(
                      ...
                      n.createElement(h.Z, { src: a(13006) })
                    ),
                    F(W.pagesSelected, { arg0: X.size })
                  ),
                  className: r()({
              ...
              () =>
                C.map((e, t) => {
                  ...
                  if (((0, d.kG)(s), 'custom' === s)) {
                    ...
                    if (a) {
                      const t = {
                        setOperations: (e, t) => {
                          ...
                          if (!l.aV.isList(a))
                            throw new d.p2(
                              'The setOperations callback must return an Immutable List of DocumentOperation objects.'
                            );
                          _(a), t && q((0, l.l4)());
                        },
                    ...
                    return i
                      ? n.createElement(k.Z, { className: o, onPress: e, key: c || t, node: i })
                      : null;
                  }
                  {
                    const e = Dt[s];
            ...
            xt = (e) => {
              if (e.onPress) {
                ...
                return async (a) => {
                  ...
                  try {
                    var o;
                    await (null === (o = e.onPress) || void 0 === o
                      ? void 0
                      : o.call(e, a, t, e.id));
                  } catch (a) {
                    throw a;
          ...
          return n.createElement(
            ...
            n.createElement(
              ...
              n.createElement(
                'div',
                { ref: vt, className: H.toolbarContainer },
                n.createElement(O, {
                  items: yt,
                  builtInItems: Pt,
                  moveDialog: wt,
            ...
            n.createElement(
              ...
              n.createElement(w.Z, { onResize: dt }),
              !It && wt,
              n.createElement(
                'div',
                { className: r()(H.pagesGrid, { [H.pagesGridLargeThumbnails]: te }), ref: St },
                n.createElement(v.Z, {
            ...
            n.createElement(
              'div',
              { className: r()(H.bottomBar, 'PSPDFKit-DocumentEditor-Footer') },
              Ct
            )
          );
        },
        W = (0, i.vU)({
          ...
          zoomOut: {
            ...
            description: 'Zoom out the document'
          }
        });
    },
    33720: (e, t, a) => {
